...
load(results_file)
comparison_exp = 'exp1';
permutation_test_file = fullfile(file_path, sprintf('../../results/%s/permutation_test_%s_vs_%s.mat', exp_name, exp_name, comparison_exp)); % get path to save permutation test results
