...
ax2.YLim = ax1.YLim;
ax2.XLim = ax1.XLim;
ax2.Position(1) = ax2.Position(1)*0.95;
axis off
set(gcf, 'InvertHardCopy', 'off'); 
set(gcf, 'Color', 'w');

% save figure as svg
save_name = fullfile(save_path, sprintf('%s_matched_results.svg', exp_name));