...
load(results_file)
permutation_test_file = fullfile(file_path, sprintf('../../results/%s/matched_permutation_test_%s.mat', exp_name, exp_name)); % get path to save permutation test results
